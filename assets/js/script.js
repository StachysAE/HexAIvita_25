...
document.addEventListener('visibilitychange',
    function(){
        if(document.visibilityState === "visible"){
            document.title = "HEXAIVITA '25";
            $("#favicon").attr("href", "/assets/images/logo.jpeg");
        }
        else {
            document.title = "Come Back To HEXAIVITA '25";
            $("#favicon").attr("href","/assets/images/logo.jpeg");
        }
    });
...
var typed = new Typed(".typing-text", {
    strings: ["Explainable AI in Healthcare"],
    loop: true,
    typeSpeed: 50,
    backSpeed: 25,
    backDelay: 500,
      ...
      <div class="content">
        ...
        <div class="desc">
          ...
          <div class="btns">
            ...
            <a href="${project.links.code}" class="btn" target="_blank">Code <i class="fas fa-calendar"></i></a>
          </div>
        </div>
      </div>
    </div>`
...
srtop.reveal('.spons .content h3', { delay: 100 });
srtop.reveal('.spons .content .tag', { delay: 100 });
srtop.reveal('.spons .content p', { delay: 100 });
srtop.reveal('.spons .content .box-container', { delay: 100 });
srtop.reveal('.spons .content .resumebtn', { delay: 100 });
